    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('more_info', models.TextField(blank=True, null=True, verbose_name='info')),
                ('rate', models.CharField(blank=True, max_length=256, null=True, verbose_name='rate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opportunity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='opportunity.Opportunity', verbose_name='opportunity')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opportunity_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='opportunity.OpportunityProfile', verbose_name='opportunity_profile')),
